...
class RCundo extends Phaser.Scene {
    ...
    create(){
        console.log("Undo version Ready!");
...
//------------DATA--COLLECTION--------------------------------------------------
    ...
    undo_data(mouse, time, blk, trl_id, map_id){
      ...
      //need pop function: myFish.splice(3, 1)  remove 1 item at index 3
...
//--------GAME--LOOP------------------------------------------------------------
    update(){
      ...
      //
      // while (trl_run){
      //   if (this.input.keyboard.on('keydown_Z'), function(){
      //     console.log('out of run loop');
      //   }){
      //     break
      //   }
      // };
      ...
      // if (this.choice_dyn[this.choice_dyn.length-1]!=0 && Phaser.Input.Keyboard.Key.isDown()){
      //   console.log("key down");
      // };

      this.input.keyboard.on('keydown_Z', function(){
        console.log("Pressed Z for undo");
        // console.log(this.choice_dyn);
        console.log(this.choice_dyn);
        let undo_check = 2;
        //this list is currently undefined for this function
        if (undo_check!=0){
          console.log("undo");
        }
      });
      ...
      //   console.log("Pressed Z for undo");
      //   console.log(this.choice_dyn);
      //   if (this.choice_dyn[this.choice_dyn.length-1] != 0){
      //     // console.log("Pressed Z for undo");
      //     this.undo_data();
      //   };
      // });
