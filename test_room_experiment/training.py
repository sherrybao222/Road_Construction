...
def ins_2(screen): 
    ...
    text_write('You will do each task twice.', 50, BLACK, 50, 500,screen)
    text_write('Now we are going to show you the instructions for these 3 tasks. ', 50, BLACK, 50, 600,screen)
    text_write('Press SPACE to continue', 50, BLACK, 50, 900, screen)
