...
def game_start(screen,blk): 
    text_write('This is Part '+ str(blk) + ' on Number Estimation',100, BLACK, 200, int(HEIGHT/4), screen)
    text_write('How many cities can you connect',
               60, BLACK, 400, int(HEIGHT/4)+200, screen)
    text_write('using the given budget by following the labeled order?',
               60, BLACK, 400, int(HEIGHT/4)+300, screen)
    text_write('Remember to type your answer in the textbox ', 60, BLACK, 400, int(HEIGHT/4)+400, screen)
    text_write('Press SPACE to continue', 60, BLACK, 400, 900, screen)

def trial_start(screen):
    text_write('This is Number Estimation',50, BLACK, 50, 100, screen)
    text_write('The green line is your budget line, and you can rotate it by using your mouse.', 50, BLACK, 50, 300,screen)
    text_write('You are asked to estimate the number of cities you can connect with the given budget. ', 50, BLACK, 50, 400,screen)
    text_write('Please remember that all cities must be connected in a labeled order. ', 50, BLACK, 50, 500,screen)
...
def post_block(screen,blk):
    text_write('Congratulation, you finished Part '+ str(blk),100, BLACK, 200, int(HEIGHT/4), screen)
