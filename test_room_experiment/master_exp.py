...
with open('/home/malab/Desktop/Road_Construction/map/num_training','r') as file: 
    train_num_map = json.load(file) 
with open('/home/malab/Desktop/Road_Construction/map/basic_map/basic_map_training','r') as file: 
    train_basic_map = json.load(file) 
with open('/home/malab/Desktop/Road_Construction/map/undo_map_training','r') as file: 
    train_undo_map = json.load(file) 

with open('/home/malab/Desktop/Road_Construction/map/num_48','r') as file: 
    num_map = json.load(file) 
with open('/home/malab/Desktop/Road_Construction/map/basic_map_48_all4','r') as file: 
    basic_map = json.load(file) 
with open('/home/malab/Desktop/Road_Construction/map/undo_map_48_all4','r') as file: 
