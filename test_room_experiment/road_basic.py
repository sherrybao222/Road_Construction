...
def game_start(screen,blk): 
    text_write('This is Part '+ str(blk) + ' on Road Construction',100, BLACK, 200, int(HEIGHT/4), screen)
    text_write('Remember you should connect as many cities',
               60, BLACK, 400, int(HEIGHT/4)+200, screen)
    text_write('as possible to achieve a higher score.',
               60, BLACK, 400, int(HEIGHT/4)+300, screen)
    text_write('You will press SPACE to submit your final score', 60, BLACK, 400, int(HEIGHT/4)+400, screen)
    text_write('Press SPACE to continue', 60, BLACK, 400, 900, screen)

def trial_start(screen):
    text_write('This is Road Construction',50, BLACK, 50, 100, screen)
    ...
    text_write('The score bar indicates your score in respect to the number of cities connected. ', 50, BLACK, 50, 500,screen)
    text_write('You will need to press SPACE to submit your final score.  ', 50, BLACK, 50, 600,screen)
