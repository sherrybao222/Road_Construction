...
input_dir  = 'road_construction/experiments/pilot_0320/data/data_pilot/'
output_dir = 'road_construction/experiments/pilot_0320/data/data_pilot_preprocessed/'
...
for num in subs:
    ...
    undo_index = [] # undo condition trial index
