...
while True:
    ...
    t2 = time.clock()
    print('TIME_CLOCK: ' + str(t2 - t1) + 'seconds')
    ...
    with open('./basic_map_100_' + date_time, 'w') as file:
        json.dump(map_list, file)
    with open('./basic_tree_100_' + date_time, 'w') as file:
        json.dump(breath_first_tree, file)
    with open('./basic_summary_100_' + date_time, 'w') as file:
