from util_figure import plot_figure_choice_level, plot_figure_puzzle_level
...
fig_class = plot_figure_puzzle_level.figure_plott(home_dir=home_dir, map_dir=map_dir, data_dir=data_dir, out_dir = out_dir)
# fig_class.rc_undo_hist_all_across_subjects_ag()
# fig_class.rc_undo_hist_all_across_subjects()
# fig_class.rc_undo_c_numciti()
# fig_class.rc_undo_c_reward()
fig_class.rc_undobenefit_undonum()
