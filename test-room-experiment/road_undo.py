...
def game_start(screen,blk): 
    text_write('This is Part '+ str(blk) + ' on Road Construction with Undo',100, BLACK, 200, int(HEIGHT/4), screen)
    ...
    text_write('And, you can press Z to undo your connections.', 60, BLACK, 400, int(HEIGHT/4)+400, screen)
    text_write('You will press SPACE to submit your final score', 60, BLACK, 400, int(HEIGHT/4)+500, screen)
    text_write('Press SPACE to continue', 60, BLACK, 400, 900, screen)
    
def trial_start(screen):
    text_write('This is Road Construction with Undo',50, BLACK, 50, 100, screen)
